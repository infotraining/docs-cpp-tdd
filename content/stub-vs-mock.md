...
1. Konfiguracja danych.
   Konfigurujemy, jakie dane są zwracane z obiektu współpracującego.
...
Po teście sprawdzamy asercją stan SUT oraz weryfikujemy zachowanie obiektu mocka (czy zostały wywołane na nim oczekiwane metody).
